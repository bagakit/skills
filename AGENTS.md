...
<bagakit-rule skill="bagakit-visual-explainer">Trigger: A user wants a zero-background, visual-first explanation delivered as an HTML artifact. | Do: Build a low-text HTML explanation in the user's language, preserving an architecture map and root-level mechanism. | See: `skills/human-improvement/bagakit-visual-explainer/SKILL.md`</bagakit-rule>
